 ...
 *
 * Works with the following database:
 *
 * create database cities;
 * create table City (
 *     CityName varchar(30) default null
 * ) ENGINE=InnoDB DEFAULT CHARSET=ascii;
 * insert into City (CityName) values ('Paris, France');
 * insert into City (CityName) values ('San Francisco, USA');
 * insert into City (CityName) values ('Sydney, Australia');
 *
 * Compile with:
 * gcc MySQLConnectorC++Client.cpp -o MySQLConnectorC++Client -lmysqlcppconn
 */
