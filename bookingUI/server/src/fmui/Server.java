    ...
    public void run() {
        while (true) {
            ...
            try {
                ...
                clientType = c.initClient();

                switch(clientType) {
                case ClientData.USER:
                ...
                try {
                    synchronized(lockObject) {
                        ...
                        if (userData.readUserData()) {
                            System.out.format("User->Server: ;%d:%d:%d:%d\n", userData.getID(), userData.getTaskID(), userData.getPickupOption(), userData.getDropoffOption());
                        ...
                        if (dataFromServerToUserID != -1 && dataFromServerToUserID == userData.getID()) {
                            ...
                            if (cidx != -1) {
                                ...
                                for (int i=0;i<userData.getDataToUserList().size();i++) {
                                    ...
                                    dataSentToUser = ";" + dataToUser.taskID + ":" + dataToUser.waitTime + ":" + dataToUser.carID;
                    ...
                    synchronized(lockObject) {
                        if (dataFromServerToSchedulerID != -1) {
                            ...
                            if (cidx != -1) {
                                ...
                                dataSentFromServerToScheduler = ";" + userData.getID() + ":" + userData.getTaskID() + ":" + userData.getPickupOption() + ":" + userData.getDropoffOption();
                        ...
                        //if (schedulerData.readSchedulerData()) {
                            while (schedulerData.readSchedulerData()) {
                                ...
                                db.updateWaitTimeAndCarID(dataFromSchedulerToServerID,
                                    schedulerData.getDataToServer());
