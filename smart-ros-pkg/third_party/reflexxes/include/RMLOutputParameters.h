...
//  ----------------------------------------------------------
	RMLOutputPolynomials(const unsigned int DegreesOfFreedom)
	{
		...
		this->NumberOfCurrentlyValidSegments	=	new unsigned int	[this->NumberOfDOFs]	;
...
//  ----------------------------------------------------------
	RMLOutputPolynomials(const RMLOutputPolynomials &P)
	{
		...
		this->NumberOfCurrentlyValidSegments	=	new unsigned int	[P.NumberOfDOFs]	;
...
//  ----------------------------------------------------------
	unsigned int			*NumberOfCurrentlyValidSegments;
...
//! trajectory for one single DOF may consist of up to 14 polynomial
//! segments. The coefficients of a single polynomial can be accessed by
//! <c>RMLPolynomial::Coefficients[k][l]</c>, where \c k is the
