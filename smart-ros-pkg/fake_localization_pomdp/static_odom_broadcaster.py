...
odo_point = Point(0,0,0)

def odo_callback(v):
    global odo_point
    odo_point = v.pose.pose.position
...
def publishOdom():
    ...
    rospy.Subscriber("phidget_encoder_odo", Odometry, odo_callback)
    ...
    odom.pose.pose = Pose(odo_point, Quaternion(*quat))       
    ...
    while not rospy.is_shutdown():
        ...
        pub.publish(odom)
        tf_pub.sendTransform((odo_point.x,odo_point.y,odo_point.z), quat,
