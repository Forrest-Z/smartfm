...
/**
 * This code is meant to use with Logitech FREEDOM 2.4 cordless joystick (Pilot joystick)
 * 
 */
#include <stdio.h>
...
{
		//The Freedom joystick has 6 axes (X,Y,Rot,Throttle,Hat0X,Hat0Y)
		//and has 10 buttons (Trigger, ThumbBtn, ThumbBtn2, TopBtn, TopBtn2, PinkieBtn, BaseBtn, BaseBtn2, BaseBtn3, BaseBtn4).
