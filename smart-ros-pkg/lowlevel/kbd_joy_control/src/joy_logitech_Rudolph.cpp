...
#define FULL_BRAKE -90
#define FULL_THROTTLE 0.2
...
void joyCallBack(sensor_msgs::Joy joy_msg)
{
    ...
    std_msgs::Float64 W;
    double steering_linear =  lat * STEER_ANG_MAX;
    W.data = steering_linear*(1-exp(-0.025*fabs(steering_linear)));
