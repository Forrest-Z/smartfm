...
class AMCLSensor
{
  ...
  // has been updated.
  public: virtual bool UpdateAction(pf_t *pf, AMCLSensorData *data, void* arg);
  ...
  //new function added 20111222;
  //validate sensor informatoin before use;
  //serving as one sub-function inside "UpdateSensor";
