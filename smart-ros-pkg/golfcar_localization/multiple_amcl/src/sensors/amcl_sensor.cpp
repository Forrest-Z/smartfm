...
bool AMCLSensor::UpdateAction(pf_t *pf, AMCLSensorData *data, void* arg)
{
  return false;
}
...
bool AMCLSensor::UpdateSensor(pf_t *pf, AMCLSensorData *data, bool *UseFlag, bool ValidSwitch, void *otherSensingSource)
{
  return false;
}
