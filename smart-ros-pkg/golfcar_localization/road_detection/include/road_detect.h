...
private:
	...
	//svm features extraction
	void svmLeftCurbFeatures(sensor_msgs::PointCloud &laser_cloud, int PID_begin, int PID_end);
	void svmRightCurbFeatures(sensor_msgs::PointCloud &laser_cloud, int PID_begin, int PID_end);

	ros::Publisher curbPCIDLeft_pub_;
	ros::Publisher curbPCIDRight_pub_;
