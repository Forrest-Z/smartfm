...
namespace golfcar_vision{
  ...
  void brightness_control::generate_ctrl_cmd(image_brightness_control::image_brightness & brightness_indicator)
  {
	  ...
	  float control_step = k_p* k_err+ k_i*i_err;
	  last_err = error;
	  ...
	  */
	  ...
	  ROS_INFO("new exposure %d,step:%f,error:%d", control_command_,control_step,(int)error);
