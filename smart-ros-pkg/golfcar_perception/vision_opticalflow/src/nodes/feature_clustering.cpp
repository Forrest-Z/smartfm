...
//             return;
    ...
    for (unsigned int m = 0; m < clusters_pos_left.clusters_info.size(); m++) clusters_pos.clusters_info.push_back(clusters_pos_left.clusters_info[m]);
    for (unsigned int n = 0; n < clusters_pos_right.clusters_info.size(); n++) clusters_pos.clusters_info.push_back(clusters_pos_right.clusters_info[n]);
