...
private:
    ...
    message_filters::Subscriber<vision_motion_detection::Blobs> blobs_sub_;

    typedef message_filters::sync_policies::ApproximateTime<
        sensor_msgs::Image, vision_motion_detection::Blobs
      > MySyncPolicy;
    ...
    void blobsCallback(const sensor_msgs::Image::ConstPtr & frame,
            const vision_motion_detection::Blobs::ConstPtr & blobs);
};
...
void BlobDisplayNode::blobsCallback(const sensor_msgs::Image::ConstPtr & frame,
        const vision_motion_detection::Blobs::ConstPtr & blobs_msg)
{
