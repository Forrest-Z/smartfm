...
#include "people_detector/dis_histogram.h"
   ...
   class people_detect{
    ...
    //2	   ros::Subscriber laser_sub;       //have point_sub
	   ...
	   ros::Publisher veri_obj_shows;
		...
		ros::Publisher mix_obj_shows;
           
	   geometry_msgs::Point TracVeriNum;   // TracVeriNum.x is trackedNum; TracVeriNum.y is VeriNum;
	   ros::Publisher TracVeriNum_pub;	

		void HistorCreat(const people_detector::people_rect& temp_veri_obj_para, people_detector::dis_histogram& HistorPara);
		people_detector::dis_histogram LaserDisHisto_;
		people_detector::dis_histogram VisionDisHisto_;
		people_detector::dis_histogram MixDisHisto_;

		ros::Publisher LaserHistoPub_;
		ros::Publisher VisionHistoPub_;
		ros::Publisher MixHistoPub_;
   };
};
