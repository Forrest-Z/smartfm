...
*/
class NonLinearAnalyticConditionalGaussianMobile : public BFL::AnalyticConditionalGaussianAdditiveNoise
{
public:
    /// Constructor
    ...
    */
    NonLinearAnalyticConditionalGaussianMobile(const BFL::Gaussian& additiveNoise);
