...
pedestrian_mdp::pedestrian_mdp(int argc, char** argv) {
	ros::NodeHandle nh;
	robotSub_ = nh.subscribe("robot_0/base_pose_ground_truth", 1, &pedestrian_mdp::robotPoseCallback, this);
	pedSub_ = nh.subscribe("robot_1/base_pose_ground_truth", 1, &pedestrian_mdp::pedPoseCallback, this);
	//subscribe as heartbeat of the robot
	scanSub_ = nh.subscribe("robot_0/base_scan", 1, &pedestrian_mdp::scanCallback, this);
...
void pedestrian_mdp::pedPoseCallback(nav_msgs::Odometry odo)
{
...
void pedestrian_mdp::scanCallback(sensor_msgs::LaserScan laser)
{
...
int main(int argc, char** argv)
{
	ros::init(argc, argv, "mdp");
		 ...
		 pedestrian_mdp::pedestrian_mdp* mdp_node;
		 mdp_node = new pedestrian_mdp::pedestrian_mdp(argc, argv);
