...
{
	//cout << "calling getJointUnobsStateProbVector" << endl;
    int Xc = b->sval; // currrent value for observed state variable
    ...
    copy(Bc, *(b->bvec));
    //cout << " Check Bc "; Bc.write(cout); cout << endl; 

	//cout << " this->XStates->size() : " << this->XStates->size() << endl;
    ...
    //cout << " Check tmp "; tmp.write(cout); cout << endl; 
    //cout << " Check tmp1 "; tmp1.write(cout); cout << endl; 

    copy(result, tmp1);
    
    //cout << " result " ; result.write(cout); cout << endl;
    return result;
}
