...
private:
    ...
    message_filters::Subscriber<infrastructure_road_monitoring::Tracks> tracks_sub_;

    typedef message_filters::sync_policies::ApproximateTime<
        sensor_msgs::Image, infrastructure_road_monitoring::Tracks
      > MySyncPolicy;
    ...
    void tracksCallback(const sensor_msgs::Image::ConstPtr & frame,
            const infrastructure_road_monitoring::Tracks::ConstPtr & tracks);
};
...
void TrackDisplayNode::tracksCallback(const sensor_msgs::Image::ConstPtr & frame,
        const infrastructure_road_monitoring::Tracks::ConstPtr & tracks_msg)
{
