#ifndef POINTCLOUD_IPM_H
#define POINTCLOUD_IPM_H
...
namespace golfcar_vision{
    ...
    class pointcloud_ipm {
		...
		ros::Publisher space_pointcloud_pub_;
		void pointcloudCallback(const sensor_msgs::PointCloudConstPtr  cloud_in);
