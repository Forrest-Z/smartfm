...
namespace golfcar_vision{
    ...
    {
        ros::NodeHandle nh;
        CamInfo_pub_ = nh.advertise<sensor_msgs::CameraInfo>("/usb_cam/camera_info", 2);
        image_sub_ = it_.subscribe("/usb_cam/image_raw", 1, &addCamInfo::imageCallback, this);
    ...
    void addCamInfo::imageCallback(const sensor_msgs::ImageConstPtr& msg_ptr)
    {
        ...
        CameraStaticInfo_.header.frame_id = "logitech_cam";
