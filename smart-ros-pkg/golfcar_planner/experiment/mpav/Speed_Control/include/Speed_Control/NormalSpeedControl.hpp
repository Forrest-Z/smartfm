/*
 * NormalSpeedControl.hpp
 *
 *  Created on: Dec 7, 2013
 *      Author: liuwlz
 */

#ifndef NORMALSPEEDCONTROL_HPP_
#define NORMALSPEEDCONTROL_HPP_
...
class NormalSpeedControl{
	...
	NormalSpeedControl()
	{
		...
		odo_sub_ = nh_.subscribe("odom", 1, &NormalSpeedControl::odom_callback, this);
		vehicle_angle_sub_ =  nh_.subscribe("move_status", 1, &NormalSpeedControl::angle_callback, this);
		...
		tf_filter_->registerCallback(boost::bind(&NormalSpeedControl::laserCB, this, _1));
		tf_filter_->setTolerance(ros::Duration(0.05));

	    advised_speed_sub_ = nh_.subscribe("cmd_speed", 1, &NormalSpeedControl::adviseSpeedCB, this);
