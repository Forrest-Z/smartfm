#ifndef PEDESTRIAN_MULTIPLE_H
#define PEDESTRIAN_MULTIPLE_H

#include "simulator.h"
#include "coord.h"
#include "grid.h"

class PEDESTRIAN_MULTIPLE_STATE:public STATE
{
public:
    COORD RobPos;
    Vector<COORD> PedPoses;
    int   Vel;
    int   Goal;
};

class PEDESTRIAN_MULTIPLE:public SIMULATOR
{
public:
    PEDESTRIAN_MULTIPLE(int size);
    ...
    void NToState(int n,PEDESTRIAN_MULTIPLE_STATE*);
...
private:
    mutable MEMORY_POOL<PEDESTRIAN_MULTIPLE_STATE> MemoryPool;
};
