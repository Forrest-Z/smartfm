...
public:
	...
	MCTS(SIMULATOR& simulator, const PARAMS& params,STATE*state);
    ~MCTS();
	...
	PEDESTRIAN_DYNAMIC_UTOWN*pedproblem_u;
...
private:
	...
	/*temporarily remove the const keyword for qmdp convenience*/
    SIMULATOR& Simulator;
