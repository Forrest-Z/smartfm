...
class TESTPROBLEM_STATE:public STATE
{
public:
    COORD RobPos;
    COORD PedPos;
...
class TESTPROBLEM:public SIMULATOR
{
public:
    TESTPROBLEM(int size);
    ...
    void NToState(int n,TESTPROBLEM_STATE*);
...
private:
    mutable MEMORY_POOL<TESTPROBLEM_STATE> MemoryPool;
};
