#ifndef SimulationEngine2_H
#define SimulationEngine2_H
...
namespace momdp
{
    ...
    class SimulationEngine2
    {
        ...
        public:
            ...
            int runFor(int iters, ofstream* streamOut, double& reward, double& expReward, bool& algo, int& rx, ofstream& statfile);
            
            int runStep();



            virtual ~SimulationEngine2(void);
    };
