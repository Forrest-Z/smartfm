...
namespace golfcar_pcl{
    ...
    message_filters::Subscriber<laser_detector::pcl_indices> 	*pcl_indices_sub_;
	message_filters::TimeSynchronizer<RollingPointCloud, laser_detector::pcl_indices> *sync_;
	message_filters::Subscriber<nav_msgs::Odometry>			odom_sub_;
	tf::MessageFilter<nav_msgs::Odometry>			*odom_filter_;

	void pclCallback(const RollingPointCloud::ConstPtr& pcl_in, const laser_detector::pcl_indices::ConstPtr &indices_in);
	...
	void surface_extraction (const RollingPointCloud &cloud_in, const laser_detector::pcl_indices & proc_indices,
	...
	bool extract_training_data_scan_, extract_training_data_point_, boundary_adjust_;
