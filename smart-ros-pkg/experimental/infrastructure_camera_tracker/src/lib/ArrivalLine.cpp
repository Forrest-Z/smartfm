...
*/
#include <infrastructure_camera_tracker/ArrivalLine.hpp>

cv::Point2f ArrivalLine::new_point = cv::Point2f(0, 0);
bool ArrivalLine::user_added_point = false;
unsigned short int ArrivalLine::id_count = 0;

const bool ArrivalLine::getIntersection(const cv::Point2f& position,
