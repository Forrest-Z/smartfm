...
void panTiltAngleCB(const pan_tilt_udp_remap::pan_tilt_msg::ConstPtr pan_tilt_angle_ptr)
{
	std_msgs::Float32 pan_angle;
	pan_angle.data = pan_tilt_angle_ptr->pan_angle;
	pan_angle_pub_->publish(pan_angle);

	std_msgs::Float32 tilt_angle;
	tilt_angle.data = pan_tilt_angle_ptr->tilt_angle;
	tilt_angle_pub_->publish(tilt_angle);
}
...
*/
	...
	ros::Subscriber pan_tilt_angle_sub = nh.subscribe
("pan_tilt_servo_angle_udp",1,panTiltAngleCB,ros::TransportHints().udp());
